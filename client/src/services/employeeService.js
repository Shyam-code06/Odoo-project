...
let MOCK_DEPARTMENTS = [
  { id: 'dept-001', name: 'Engineering', code: 'ENG', description: 'Software engineering & product development' },
  { id: 'dept-002', name: 'Human Resources', code: 'HR', description: 'Talent acquisition, operations & compliance' },
  { id: 'dept-003', name: 'Finance & Payroll', code: 'FIN', description: 'Accounting, compensation & payroll' },
  { id: 'dept-004', name: 'Product & Design', code: 'PD', description: 'Product management & UI/UX design' },
  { id: 'dept-005', name: 'Marketing & Sales', code: 'MKT', description: 'Growth, brand & business development' },
];

let MOCK_JOB_POSITIONS = [
  { id: 'pos-001', title: 'Software Engineer', code: 'SE', department_id: 'dept-001' },
  { id: 'pos-002', title: 'Senior Frontend Engineer', code: 'SFE', department_id: 'dept-001' },
  { id: 'pos-003', title: 'Backend Tech Lead', code: 'BTL', department_id: 'dept-001' },
  { id: 'pos-004', title: 'HR Operations Specialist', code: 'HRS', department_id: 'dept-002' },
  { id: 'pos-005', title: 'HR Manager', code: 'HRM', department_id: 'dept-002' },
  { id: 'pos-006', title: 'Payroll Analyst', code: 'PA', department_id: 'dept-003' },
  { id: 'pos-007', title: 'Finance Lead', code: 'FL', department_id: 'dept-003' },
  { id: 'pos-008', title: 'Product Designer', code: 'PD', department_id: 'dept-004' },
  { id: 'pos-009', title: 'Product Manager', code: 'PM', department_id: 'dept-004' },
  { id: 'pos-010', title: 'Marketing Executive', code: 'ME', department_id: 'dept-005' },
];

let MOCK_WORKING_SCHEDULES = [
  { id: 'sched-001', name: 'Full-Time Standard (Mon-Fri 09:30 - 18:30)', hoursPerWeek: 40, breakDuration: '60 mins' },
  { id: 'sched-002', name: 'Flexi Shift (Mon-Fri 10:00 - 19:00)', hoursPerWeek: 40, breakDuration: '60 mins' },
  { id: 'sched-003', name: 'Part-Time Morning (Mon-Thu 09:00 - 13:00)', hoursPerWeek: 16, breakDuration: '15 mins' },
];
