                ...
                <div className="space-y-3 pt-3 border-t border-slate-100">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <button
                      ...
                      className="flex-1 py-1.5 px-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg text-xs font-medium flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 py-1.5 px-2 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-lg text-xs font-medium flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                    >
