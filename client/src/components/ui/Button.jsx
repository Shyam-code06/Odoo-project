...
export const Button = React.forwardRef(
  (
    ...
    const baseStyles =
      'inline-flex flex-row items-center justify-center font-medium rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed select-none cursor-pointer whitespace-nowrap';
    ...
    return (
      ...
      >
        ...
        {children && (
          <span className={`whitespace-nowrap ${responsive && hasIcon ? 'hidden sm:inline' : ''}`}>
            {children}
          </span>
        )}
